...
import { ArrowLeft, Loader2, Play, Eye, PenLine, Trophy } from "lucide-react";
          ...
          {attempts?.map((a) => (
            ...
            >
              <div className="flex min-w-0 items-center gap-3">
                <span className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full ${a.testKind === "Mock" ? "bg-accent-50 text-accent-600" : "bg-mint-50 text-mint-500"}`}>
                  {a.testKind === "Mock" ? <Trophy className="h-4 w-4" strokeWidth={2.25} /> : <PenLine className="h-4 w-4" strokeWidth={2.25} />}
                </span>
