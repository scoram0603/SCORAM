...
import { LogOut, Mail, User as UserIcon, Users, MessageCircle, Loader2, Smartphone, Camera, X } from "lucide-react";
...
export default function Profile() {
  ...
  return (
    <div className="flex flex-col items-center px-6 py-10 sm:py-16">
      ...
      <p className="mt-4 max-w-sm text-center text-xs text-ink-400">
        Level, XP, streaks, and badges will show here once the gamification module is wired to the backend.
      </p>
