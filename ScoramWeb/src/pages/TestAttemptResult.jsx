  ...
  return (
    <div className="px-4 pb-10 pt-4 sm:px-6 lg:px-8 lg:pt-6">
      ...
      <div className="mt-3 rounded-xl2 border border-primary-100 bg-white p-5 shadow-card">
        <p className="text-xs font-bold uppercase tracking-wide text-secondary-500">{result.testKind === "Mock" ? "Mock Test" : result.testKind === "PreviousYearPaper" ? "Previous Year Paper" : "Practice Test"}</p>
