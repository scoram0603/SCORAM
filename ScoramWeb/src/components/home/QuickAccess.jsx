...
// Maps each card's data-key to an actual route. "quizzes" still falls through to its own /key
// route -- a "Coming Soon" screen, since Exam Utility isn't built yet. "progress" also falls
// through to /progress, but that's a real page now (see pages/Progress.jsx) -- no override
// needed here since the key already matches the route.
const ROUTE_FOR_KEY = {
