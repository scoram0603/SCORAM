...
// SHARING -- same card design as GroupChat.jsx's QuestionShareCard (identical DTO shape from the
// backend, see DirectMessageResponseDto vs ChatMessageResponseDto's matching Shared* fields).
