...
namespace ScoramAPI.Migrations
{
    ...
    [Migration("20260726155953_StudentUsernameAndRequiredFields")]
    partial class StudentUsernameAndRequiredFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ScoramAPI.Models.ChatRoom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000001"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discussion room for SSC CGL aspirants",
                            IsActive = true,
                            Name = "SSC CGL"
                        },
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000002"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discussion room for SSC CHSL aspirants",
                            IsActive = true,
                            Name = "SSC CHSL"
                        },
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000003"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discussion room for Railway NTPC aspirants",
                            IsActive = true,
                            Name = "Railway NTPC"
                        },
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000004"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discussion room for Railway Group D aspirants",
                            IsActive = true,
                            Name = "Railway Group D"
                        },
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000005"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Ask and resolve daily doubts",
                            IsActive = true,
                            Name = "Daily Doubt Room"
                        },
                        new
                        {
                            Id = new Guid("3c9e0a1b-1111-4a2b-8c3d-000000000006"),
                            CreatedAt = new DateTime(2026, 7, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Discuss daily current affairs",
                            IsActive = true,
                            Name = "Current Affairs Room"
                        });
                });
            ...
            modelBuilder.Entity("ScoramAPI.Models.Paper", b =>
                {
                    ...
                    b.HasIndex("ExamId", "Year", "Shift", "Language");
