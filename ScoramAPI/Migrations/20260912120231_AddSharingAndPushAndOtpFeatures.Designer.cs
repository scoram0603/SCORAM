...
namespace ScoramAPI.Migrations
{
    ...
    [Migration("20260912120231_AddSharingAndPushAndOtpFeatures")]
    partial class AddSharingAndPushAndOtpFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScoramAPI.Models.ChatMessage", b =>
                {
                    ...
                    b.Property<Guid?>("SharedContentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("SharedContentSubtitle")
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
                    ...
                    b.Property<int?>("SharedContentType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ScoramAPI.Models.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScoramAPI.Models.QuestionBankImportJob", b =>
                {
                    ...
                    b.Property<string>("CandidateEmptyExamIds")
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("ScoramAPI.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DmLastSeenAt")
                        .HasColumnType("datetime2");
