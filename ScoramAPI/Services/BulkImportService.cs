...
namespace ScoramAPI.Services
{
    ...
    public class BulkImportService : IBulkImportService
    {
        ...
        // Shared row-building logic for all three formats -- `field` abstracts over "get this named
        // field's raw string value", however the underlying format actually stores it.
